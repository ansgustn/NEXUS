...
const DEFAULT_FIGURES = [
  {
    ...
    era: "근현대 (1876 ~ 1949)",
    ageCategory: "장년/노년",
    voiceProfile: { voiceName: "ko-KR-InJoonNeural", tone: "중저음의 단호하고 진정성 있는 톤", speechStyle: "격식 있고 애국심 넘치는 명료한 어조", pitch: "-25Hz", rate: "-15%", volume: "+0%" },
    portraitUrl: "/images/kim-koo.webp",
    defaultVideoUrl: "/videos/kim-koo-synced.mp4",
  ...
  },
  {
    ...
    era: "조선 전기 (1397 ~ 1450)",
    ageCategory: "중년/장년",
    voiceProfile: { voiceName: "ko-KR-InJoonNeural", tone: "위엄 있고 인자한 성군 음성", speechStyle: "백성을 사랑하는 하오체 및 어제 어조", pitch: "-16%", rate: "-12%", volume: "+0%" },
  ...
  },
  {
    ...
    era: "조선 중기 (1545 ~ 1598)",
    ageCategory: "중년/장년",
    voiceProfile: { voiceName: "ko-KR-InJoonNeural", tone: "묵직하고 힘있는 장수의 톤", speechStyle: "절제되고 굳은 의지의 장수 어조", pitch: "-14%", rate: "-8%", volume: "+0%" },
  ...
  },
  {
    ...
    era: "근대 (1902 ~ 1920)",
    ageCategory: "청년",
    voiceProfile: { voiceName: "ko-KR-SunHiNeural", tone: "맑고 맑으나 강인한 청년 음성", speechStyle: "당차고 외침에 찬 독립 의지의 어조", pitch: "+5%", rate: "-2%", volume: "+0%" },
  ...
  },
  {
    ...
    era: "조선 중기 (1504 ~ 1551)",
    ageCategory: "중년",
    voiceProfile: { voiceName: "ko-KR-SunHiNeural", tone: "단아하고 따뜻한 여류 화가 음성", speechStyle: "온화하고 학식 깊은 품격 있는 어조", pitch: "-3%", rate: "-8%", volume: "+0%" },
